...
addDef("get_test", "pub def get_test() Int {", intType, []);
addDef("get_tick", "pub def get_tick() Int {", intType, []);
addDef("get_last_time", "pub def get_last_time() Int {", intType, []);
addDef("get_memory", "pub def get_memory(label: String) Int {", intType, [stringType]);
addDef("get_setting", "pub def get_setting(idx: StateIndex) U64 {", 'U64', ['StateIndex']);
addDef("set_setting", "pub def set_setting(idx: StateIndex, value: U64) {", null, ['StateIndex', 'U64']);
...
addDef("get_ram_value", "pub def get_ram_value(label: String, address: Int, size: @Size) @Size {", anyType, [stringType, intType, anyType]);
addDef("set_ram_value", "pub def set_ram_value(label: String, offset: Int, value: @Type) {", null, [stringType, intType, anyType]);
...
addDef("set_error", "pub def set_error(input: String) {", null, [stringType]);
addDef("output", "pub def output(text: String) {", null, [stringType]);
addDef("add_keyboard_value", "pub def add_keyboard_value(up: Bool, value: U8) {", null, [boolType, 'U8']);
addDef("get_command", "pub def get_command(idx: CommandIndex) U64 {", 'U64', ['CommandIndex']);
addDef("get_component_count", "pub def get_component_count() Int {", intType, []);
addDef("get_component_count", "pub def get_component_count(component_type: ComponentType) Int {", intType, ['ComponentType']);
...
addDef('ui_set_address_color', "ui_set_address_color(id: String, value: Int) {", null, [stringType, intType]);
addDef('ui_set_color', "ui_set_color(id: String, value: Int) {", null, [stringType, intType]);
addDef('ui_set_column_header_color', "ui_set_column_header_color(id: String, value: Int) {", null, [stringType, intType]);
addDef('ui_set_column_header_size', "ui_set_column_header_size(id: String, value: Int) {", null, [stringType, intType]);
addDef('ui_set_description_color', "ui_set_description_color(id: String, value: Int) {", null, [stringType, intType]);
addDef('ui_set_hidden', "ui_set_hidden(id: String, value: Bool) {", null, [stringType, boolType]);
addDef('ui_set_image_name', "ui_set_image_name(id: String, text: String) {", null, [stringType, stringType]);
addDef('ui_set_instruction', "ui_set_instruction(index: Int, code: Int, pointer: Int) {", null, [intType, intType, intType]);
addDef('ui_set_instruction_color', "ui_set_instruction_color(id: String, value: Int) {", null, [stringType, intType]);
addDef('ui_set_position', "ui_set_position(id: String, x: Int, y: Int) {", null, [stringType, intType, intType]);
addDef('ui_set_row_header_color(id: String, value: Int) {', "ui_set_row_header_color(id: String, value: Int) {", null, [stringType, intType]);
addDef('ui_set_row_header_size', "ui_set_row_header_size(id: String, value: Int) {", null, [stringType, intType]);
addDef('ui_set_size', "ui_set_size(id: String, size: Int) {", null, [stringType, intType]);
addDef('ui_set_text', "ui_set_text(id: String, text: String) {", null, [stringType, stringType]);
addDef('ui_set_width', "ui_set_width(id: String, value: Int) {", null, [stringType, intType]);
